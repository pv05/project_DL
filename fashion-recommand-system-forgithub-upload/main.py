...
feature_list = np.array(pickle.load(urllib.request.urlopen('https://www.googleapis.com/drive/v3/files/1n9yHjmIiUTmFZb8Cm-5cwKVrlMkquDkH?alt=media&key=AIzaSyCUpIPtvM6lJw65WnZoM-Xxn7Xo6xytJ3k')))
filenames = pickle.load(urllib.request.urlopen('https://www.googleapis.com/drive/v3/files/1mdqfwxltwQpsNflTFmQdUic44uSWBX-Q?alt=media&key=AIzaSyCUpIPtvM6lJw65WnZoM-Xxn7Xo6xytJ3k'))
